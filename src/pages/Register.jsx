...
const Register = () => {
  return (
    ...
    validationSchema={Yup.object({
        ...
        password:Yup.string()
        .matches(/(?=.*[A-Za-z])(?=.*\d)(?=.*[@#$?!])[A-Za-z\d@#$?!]{8,100}$/,'Must conatin one uppercase,pne lowercase,one numeric and one special character and mus contain atleast 8 characters')
        .required('Password is mandatory'),

        cpassword:Yup.string()
        .required('Confirm password is mandatory')
        .oneOf([Yup.ref('password'),null],'password and confirm passowrd doesnot match')
